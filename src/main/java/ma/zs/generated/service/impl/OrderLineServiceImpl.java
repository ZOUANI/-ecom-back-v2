   ...
   public OrderLine update(OrderLine orderLine){
	...
	public List<OrderLine> findByCriteria(OrderLineVo orderLineVo){
      String query = "SELECT o FROM OrderLine o where 1=1 ";
		 	 ...
		 	 query += SearchUtil.addConstraint( "o", "qteEnvoye","=",orderLineVo.getQteEnvoye());
		 	 query += SearchUtil.addConstraint( "o", "qte","=",orderLineVo.getQte());
		 	 query += SearchUtil.addConstraint( "o", "qteLivre","=",orderLineVo.getQteLivre());
	  ...
	  query += SearchUtil.addConstraintMinMax("o","qteEnvoye",orderLineVo.getQteEnvoyeMin(),orderLineVo.getQteEnvoyeMax());
	  query += SearchUtil.addConstraintMinMax("o","qte",orderLineVo.getQteMin(),orderLineVo.getQteMax());
	  query += SearchUtil.addConstraintMinMax("o","qteLivre",orderLineVo.getQteLivreMin(),orderLineVo.getQteLivreMax());
