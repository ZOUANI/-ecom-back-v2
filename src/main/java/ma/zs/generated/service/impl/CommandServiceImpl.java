...
public class CommandServiceImpl implements CommandService {
    ...
    @Override
    public List<Command> save(String commands) {
    ...
    @Override
    public void saveMappedCommands(List<Command> commands) {
    ...
    private Command mapCommand(String[] line) {
        ...
        validator.setFirsttName(validatorFullName[1]);
    ...
    public CommandVo findStatisticsTotalCommandAmount(Date start, Date end) {
        ...
        CommandVo commandVo = new CommandVo(new BigDecimal(0), new BigDecimal(0), new BigDecimal(0), new BigDecimal(0));
        for (Command command : commands) {
            commandVo.setTotalCommands(command.getTotal().add(commandVo.getTotalCommands()));
