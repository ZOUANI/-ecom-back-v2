...
public class CommandeAccessServiceImpl implements CommandeAccessService {
   ...
   private EntityManager entityManager; 
	...
	@Override
	public List<CommandeAccess> findAll(){
		return commandeAccessDao.findAll();
	}	
	@Override
...
//				  commandeAccess.setCommand(command);
	          ...
	          if(commandeAccess.getValidator()!=null){
				  ...
				  commandeAccess.setValidator(validator);
			  }

	    CommandeAccess savedCommandeAccess = commandeAccessDao.save(commandeAccess);
	   return savedCommandeAccess;
	}
   ...
   if(commandeAccessVo.getCommandVo()!=null){
     ...
     query += SearchUtil.addConstraint( "o", "command.reference","LIKE",commandeAccessVo.getCommandVo().getReference());
   }
   ...
   if(commandeAccessVo.getValidatorVo()!=null){
     ...
     query += SearchUtil.addConstraint( "o", "validator.code","LIKE",commandeAccessVo.getValidatorVo().getCode());
   }
