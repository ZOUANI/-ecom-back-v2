   ...
   public Stock update(Stock stock){
	...
	public List<Stock> findByCriteria(StockVo stockVo){
      String query = "SELECT o FROM Stock o where 1=1 ";
		 	 query += SearchUtil.addConstraint( "o", "qteRestante","=",stockVo.getQteRestante());
		 	 query += SearchUtil.addConstraint( "o", "qteLivre","=",stockVo.getQteLivre());
		 	 query += SearchUtil.addConstraint( "o", "qteEnvoye","=",stockVo.getQteEnvoye());
		 	 query += SearchUtil.addConstraint( "o", "id","=",stockVo.getId());
	  query += SearchUtil.addConstraintMinMax("o","qteRestante",stockVo.getQteRestanteMin(),stockVo.getQteRestanteMax());
	  query += SearchUtil.addConstraintMinMax("o","qteLivre",stockVo.getQteLivreMin(),stockVo.getQteLivreMax());
	  query += SearchUtil.addConstraintMinMax("o","qteEnvoye",stockVo.getQteEnvoyeMin(),stockVo.getQteEnvoyeMax());
