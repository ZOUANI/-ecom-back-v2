...
public class DeliveryCostServiceImpl implements DeliveryCostService {
	...
	public DeliveryCost save(DeliveryCost deliveryCost) {
		DeliveryCost deliveryCostFound = deliveryCostDao
				.findByDeliveryCodeAndCityName(deliveryCost.getDelivery().getCode(), deliveryCost.getCity().getName());

		if (deliveryCostFound != null) {
			return null;
		}
