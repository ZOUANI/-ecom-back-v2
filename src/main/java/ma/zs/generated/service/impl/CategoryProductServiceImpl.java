...
public class CategoryProductServiceImpl implements CategoryProductService {
    ...
    public CategoryProduct save(CategoryProduct categoryProduct) {
        ...
        if (categoryProduct.getProduct() != null) {
            Product product = productService.findByLabel(categoryProduct.getProduct().getLabel());
            if (product == null)
    ...
    public CategoryProduct update(CategoryProduct categoryProduct) {
        ...
        foundedCategoryProduct.setCategory(categoryProduct.getCategory());
        foundedCategoryProduct.setProduct(categoryProduct.getProduct());
        return categoryProductDao.save(foundedCategoryProduct);
